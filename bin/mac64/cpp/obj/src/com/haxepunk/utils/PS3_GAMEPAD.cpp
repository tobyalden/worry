...
{  hx::ObjectPtr< PS3_GAMEPAD_obj > _result_ = new PS3_GAMEPAD_obj();
...
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::TRIANGLE_BUTTON,HX_HCSTRING("TRIANGLE_BUTTON","\xc9","\xb9","\x1d","\x71")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::CIRCLE_BUTTON,HX_HCSTRING("CIRCLE_BUTTON","\x81","\xe3","\xd0","\xa0")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::X_BUTTON,HX_HCSTRING("X_BUTTON","\x39","\x5a","\x31","\xa4")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::SQUARE_BUTTON,HX_HCSTRING("SQUARE_BUTTON","\x94","\xf0","\x82","\xfe")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::L1_BUTTON,HX_HCSTRING("L1_BUTTON","\xcc","\x23","\x2d","\x8d")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::R1_BUTTON,HX_HCSTRING("R1_BUTTON","\xd2","\x99","\xd5","\x7e")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::L2_BUTTON,HX_HCSTRING("L2_BUTTON","\xeb","\x95","\x5f","\xc6")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::R2_BUTTON,HX_HCSTRING("R2_BUTTON","\xf1","\x0b","\x08","\xb8")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::SELECT_BUTTON,HX_HCSTRING("SELECT_BUTTON","\x15","\x70","\xb1","\x60")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::START_BUTTON,HX_HCSTRING("START_BUTTON","\x8f","\x5f","\xaf","\xbd")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::PS_BUTTON,HX_HCSTRING("PS_BUTTON","\xee","\xef","\xa5","\x71")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::LEFT_ANALOGUE_BUTTON,HX_HCSTRING("LEFT_ANALOGUE_BUTTON","\x99","\x47","\xe7","\x94")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::RIGHT_ANALOGUE_BUTTON,HX_HCSTRING("RIGHT_ANALOGUE_BUTTON","\x4e","\x35","\x82","\x79")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::DPAD_UP,HX_HCSTRING("DPAD_UP","\x6b","\x00","\x87","\xa2")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::DPAD_DOWN,HX_HCSTRING("DPAD_DOWN","\x72","\x1a","\x5b","\x87")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::DPAD_LEFT,HX_HCSTRING("DPAD_LEFT","\x17","\x2a","\x9d","\x8c")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::DPAD_RIGHT,HX_HCSTRING("DPAD_RIGHT","\xac","\xb7","\xf4","\xf3")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::LEFT_ANALOGUE_X,HX_HCSTRING("LEFT_ANALOGUE_X","\x11","\x28","\x14","\xd2")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::LEFT_ANALOGUE_Y,HX_HCSTRING("LEFT_ANALOGUE_Y","\x12","\x28","\x14","\xd2")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::TRIANGLE_BUTTON_PRESSURE,HX_HCSTRING("TRIANGLE_BUTTON_PRESSURE","\x3b","\x78","\x94","\xdf")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::CIRCLE_BUTTON_PRESSURE,HX_HCSTRING("CIRCLE_BUTTON_PRESSURE","\x83","\x57","\x3a","\xc4")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::X_BUTTON_PRESSURE,HX_HCSTRING("X_BUTTON_PRESSURE","\xcb","\x49","\xa1","\xdd")},
	{hx::fsInt,(void *) &PS3_GAMEPAD_obj::SQUARE_BUTTON_PRESSURE,HX_HCSTRING("SQUARE_BUTTON_PRESSURE","\x10","\x90","\xe5","\x2d")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
hx::Class PS3_GAMEPAD_obj::__mClass;
...
void PS3_GAMEPAD_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("com.haxepunk.utils.PS3_GAMEPAD","\xdc","\x84","\x5c","\xc7");
	...
	__mClass->mCanCast = hx::TCanCast< PS3_GAMEPAD_obj >;
#ifdef HXCPP_VISIT_ALLOCS
