...
::haxe::io::Output Sys_obj::_stderr( ){
	HX_STACK_FRAME("Sys","stderr",0x3eb04003,"Sys.stderr","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",41,0xd23c22f3)
	HX_STACK_LINE(42)
...
::String Sys_obj::getCwd( ){
	HX_STACK_FRAME("Sys","getCwd",0xd9ded99b,"Sys.getCwd","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",72,0xd23c22f3)
	HX_STACK_LINE(73)
