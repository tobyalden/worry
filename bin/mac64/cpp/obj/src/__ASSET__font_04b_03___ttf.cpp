...
{
HX_STACK_FRAME("__ASSET__font_04b_03___ttf","new",0x28d5615d,"__ASSET__font_04b_03___ttf.new","DefaultAssetLibrary.hx",550,0x0fc48912)
HX_STACK_THIS(this)
...
bool __ASSET__font_04b_03___ttf_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
void __ASSET__font_04b_03___ttf_obj::__register()
{
	...
	__mClass->mSetStaticField = &__ASSET__font_04b_03___ttf_obj::__SetStatic;
