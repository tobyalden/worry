...
Void Stage_obj::__onKey( Dynamic event,::String type){
{
		...
		if ((tmp2)){
			...
			if ((tmp26)){
				...
				if ((tmp35)){
					HX_STACK_LINE(859)
					::openfl::_legacy::display::StageDisplayState tmp36 = this->get_displayState();		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(859)
					bool tmp37 = (tmp36 == ::openfl::_legacy::display::StageDisplayState_obj::NORMAL);		HX_STACK_VAR(tmp37,"tmp37");
					HX_STACK_LINE(859)
					if ((tmp37)){
						HX_STACK_LINE(861)
