...
::String File_obj::getContent( ::String path){
	HX_STACK_FRAME("sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","/usr/local/lib/haxe/std/cpp/_std/sys/io/File.hx",27,0x3272313d)
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_FRAME("sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/usr/local/lib/haxe/std/cpp/_std/sys/io/File.hx",32,0x3272313d)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(33)
	::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(33)
