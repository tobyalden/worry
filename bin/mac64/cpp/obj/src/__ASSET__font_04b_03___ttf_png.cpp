...
{
HX_STACK_FRAME("__ASSET__font_04b_03___ttf_png","new",0xe9393187,"__ASSET__font_04b_03___ttf_png.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_STACK_THIS(this)
...
bool __ASSET__font_04b_03___ttf_png_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
void __ASSET__font_04b_03___ttf_png_obj::__register()
{
	...
	__mClass->mSetStaticField = &__ASSET__font_04b_03___ttf_png_obj::__SetStatic;
