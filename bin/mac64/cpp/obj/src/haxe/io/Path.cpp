...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","/usr/local/lib/haxe/std/haxe/io/Path.hx",265,0xc99b0f1c)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(266)
...
::String Path_obj::removeTrailingSlashes( ::String path){
	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","/usr/local/lib/haxe/std/haxe/io/Path.hx",290,0xc99b0f1c)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(291)
	while((true)){
		HX_STACK_LINE(292)
