...
bool HasNodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.HasNodeAccess","resolve",0x2b3f8e2c,"haxe.xml._Fast.HasNodeAccess.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",86,0x1680b11e)
	HX_STACK_THIS(this)
